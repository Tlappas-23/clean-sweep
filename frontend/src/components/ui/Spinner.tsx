// Spinner: a thin accent ring used inside buttons and as a page-level loader.
...
export function PageLoader({ label = "Loading" }: { label?: string }) {
  return (
    <div className="flex flex-col items-center justify-center gap-3 py-24 text-bone-dim">
      <Spinner size={28} />
