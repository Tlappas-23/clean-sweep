...
def titles(fig, phase, headline, sub=None, x=0.012):
    ...
    fig.text(x, 1 - 0.60 / h, headline, fontsize=13.5, color=INK, fontweight="bold", ha="left", va="center")
    if sub:
        fig.text(x, 1 - 0.88 / h, sub, fontsize=10, color=MUTED, ha="left", va="center")
...
def layout(fig, phase, headline, sub=None, why_text=None, top=None, bottom=0.13, extra_bottom=0.0):
    """
