...
GROUPS: dict[str, list[str]] = {
    ...
    "studio": [
        "companies_prior_median_log",
        "companies_prior_max_log",
        "companies_prior_count",
        "is_major_studio",
    ],
    "director": ["director_prior_median_log", "director_prior_max_log", "director_prior_count"],
    "cast": ["cast_prior_median_log", "cast_prior_max_log", "cast_prior_count"],
    "cinematographer": [
        "cinematographer_prior_median_log",
        "cinematographer_prior_max_log",
        "cinematographer_prior_count",
    ],
    "composer": ["composer_prior_median_log", "composer_prior_max_log", "composer_prior_count"],
    "writer": ["writer_prior_median_log", "writer_prior_max_log", "writer_prior_count"],
}
    ...
    rows.append(
        {
            ...
            "mae_log": full_mae,
            "within_2x": full_2x,
            "d_mae": full_mae - base_mae,
            "d_2x": full_2x - base_2x,
        }
    )
